...
var IframeWalletPlugin = () => {
  ...
  const customEventHandler = useCallback(async (messageType) => {
    var _a, _b, _c, _d, _e;
    if (messageType === "open-account-and-security" /* OpenAccountAndSecurity */) {
      (_b = (_a = window.particle) == null ? void 0 : _a._internal) == null ? void 0 : _b.openAccountAndSecurity();
    } else if (messageType === "get-user-info" /* GetUserInfo */) {
      return (_e = (_d = (_c = window.particle) == null ? void 0 : _c._internal) == null ? void 0 : _d.getUserInfo) == null ? void 0 : _e.call(_d);
    }
  }, []);
  useEffect(() => {
    var _a, _b, _c;
...
//# sourceMappingURL=iframeWalletPlugin-NIUCHUJH.mjs.map
