...
// src/config.ts
var _customWalletUrl, _devEnv, _stagingEnv, _productionEnv;
var GlobalConfig = class {
  constructor() {
    __privateAdd(this, _customWalletUrl, void 0);
  ...
  get env() {
    let currentEnv = __privateGet(this, _productionEnv);
    if (!isServer() && window.__PARTICLE_ENVIRONMENT__ === "development") {
      currentEnv = __privateGet(this, _devEnv);
    } else if (!isServer() && window.__PARTICLE_ENVIRONMENT__ === "staging") {
      currentEnv = __privateGet(this, _stagingEnv);
    } else {
      currentEnv = __privateGet(this, _productionEnv);
    }
    if (__privateGet(this, _customWalletUrl)) {
      currentEnv.walletUrl = __privateGet(this, _customWalletUrl);
    }
    return currentEnv;
  }
  updateWalletUrl(url) {
    if (url) {
      __privateSet(this, _customWalletUrl, url);
    }
  }
};
_customWalletUrl = new WeakMap();
_devEnv = new WeakMap();
...
var walletIframeMask = "particle-auth-core-iframe-wallet-mask";
var EntryPosition = /* @__PURE__ */ ((EntryPosition2) => {
  ...
  EntryPosition2["MC"] = "middle-center";
...
var handleSolanaRpc = async (data, solana) => {
  ...
  if (data.method === "solana_requestAccounts") {
    const publicAddress = solana.selectedAddress || ((_a = solana.publicKey) == null ? void 0 : _a.toBase58());
    if (!publicAddress) {
      await solana.connect();
    }
    return solana.selectedAddress || ((_b = solana.publicKey) == null ? void 0 : _b.toBase58());
...
// src/walletUrl.ts
var openTimestamp = new Date().getTime();
function walletUrl({
  projectConfig,
  walletOptions,
  options,
  ...
  const topMenuType = (options == null ? void 0 : options.topMenuType) || (walletOptions == null ? void 0 : walletOptions.topMenuType);
...
var _WalletEntryPlugin = class {
  constructor() {
    this.centerWallet = false;
    this.walletCreated = false;
    __privateAdd(this, _onMessage, (event) => {
      var _a, _b, _c;
      if (((_a = event.data) == null ? void 0 : _a.type) === IframeWalletMessageType && this._walletCore) {
  ...
  init(projectConfig, options = {}) {
    ...
    this._walletOptions = {
      ...
      themeType: "light",
      ...options,
      widgetIntegration: (_a = options.widgetIntegration) != null ? _a : "modal",
      visible: (_b = options.visible) != null ? _b : true
    };
    if (options.walletUrl) {
      config_default.updateWalletUrl(options.walletUrl);
    }
    ...
    this.centerWallet = Boolean(this._walletOptions.entryPosition === "middle-center" /* MC */ || !this._walletOptions.visible);
  ...
  setWalletCore(walletCore) {
    ...
    if (this._walletCore) {
      (_b = (_a = this._walletCore.ethereum) == null ? void 0 : _a.removeListener) == null ? void 0 : _b.call(_a, "accountsChanged", __privateGet(this, _onEthereumAccountsChanged));
      (_d = (_c = this._walletCore.ethereum) == null ? void 0 : _c.removeListener) == null ? void 0 : _d.call(_c, "chainChanged", __privateGet(this, _onEthereumChainChanged));
    }
    this._walletCore = walletCore;
    if (this._walletCore.ethereum) {
      (_f = (_e = this._walletCore.ethereum) == null ? void 0 : _e.removeListener) == null ? void 0 : _f.call(_e, "accountsChanged", __privateGet(this, _onEthereumAccountsChanged));
      (_h = (_g = this._walletCore.ethereum) == null ? void 0 : _g.on) == null ? void 0 : _h.call(_g, "accountsChanged", __privateGet(this, _onEthereumAccountsChanged));
      (_j = (_i = this._walletCore.ethereum) == null ? void 0 : _i.removeListener) == null ? void 0 : _j.call(_i, "chainChanged", __privateGet(this, _onEthereumChainChanged));
      (_l = (_k = this._walletCore.ethereum) == null ? void 0 : _k.on) == null ? void 0 : _l.call(_k, "chainChanged", __privateGet(this, _onEthereumChainChanged));
    }
  }
  walletEntryCreate() {
    var _a;
    this.destroy();
    if (((_a = this._walletOptions) == null ? void 0 : _a.widgetIntegration) !== "embedded") {
      this.walletEntryRander();
      if (this._walletOptions.preload) {
        const iframe = this.getWalletIFrameImpl();
        const iframeContent = document.querySelector(".particle-pwe-iframe-content");
        if (!(iframeContent == null ? void 0 : iframeContent.childElementCount)) {
  ...
  getWalletUrl(options) {
    ...
    const url = walletUrl({
      ...
      customEventHandler: (_a = this._walletCore) == null ? void 0 : _a.customEventHandler
    });
    return url;
  }
  getWalletIFrame(options) {
  ...
  getWalletIFrameImpl(options) {
    ...
    let iframe = document.getElementById(walletIframeId);
    if (!iframe) {
  ...
  getWalletIFrameMask() {
    let mask = document.getElementById(walletIframeMask);
    if (!mask) {
  ...
  openWallet(params) {
    ...
    const modalBorderRadius = (_f = (_e = (_d = (_b = this._walletOptions) == null ? void 0 : _b.customStyle) == null ? void 0 : _d[((_c = this._walletOptions) == null ? void 0 : _c.themeType) || "light"]) == null ? void 0 : _e.cardBorderRadius) != null ? _f : 18;
    ...
    const uiMode = ((_g = this._walletOptions) == null ? void 0 : _g.themeType) || "light";
    if (uiMode == "dark") {
    ...
    const iframe = this.getWalletIFrameImpl(params);
  ...
  setWalletIcon() {
    ...
    const walletBtn = document.querySelector(".particle-pwe-btn");
    if (walletBtn && this._walletOptions.visible && this._walletOptions.entryPosition !== "middle-center" /* MC */) {
  ...
  updateIframeContentPosition() {
    ...
    } else if (walletBtnBottom + iframeContentHeight + 10 < windowHeight && walletBtnRight + iframeContentWidth + 10 < windowWidth) {
  ...
  setButtonStorageData(data) {
    const { innerWidth, innerHeight } = window;
    const position = this._walletOptions.entryPosition || "bottom-right" /* BR */;
  ...
  getButtonStorageData() {
    ...
    const { innerWidth, innerHeight } = window;
    const [x, y, direction, position] = ((_b = (_a = localStorage == null ? void 0 : localStorage.getItem(_WalletEntryPlugin.WALLET_BTN_POSITION)) == null ? void 0 : _a.split) == null ? void 0 : _b.call(_a, ",")) || [];
    ...
    return {
      x: Number(x) || 0,
      y: Number(y) || 0,
      position: position || ((_e = this._walletOptions) == null ? void 0 : _e.entryPosition),
      direction: direction || this.getDirectionFromPosition((_f = this._walletOptions) == null ? void 0 : _f.entryPosition)
    };
  }
  getInitialPositionData() {
    var _a;
    const position = ((_a = this._walletOptions) == null ? void 0 : _a.entryPosition) || "bottom-right" /* BR */;
    const { innerWidth, innerHeight } = window;
    let x, y;
    switch (position) {
      case "bottom-right" /* BR */:
  ...
  getDirectionFromPosition(position) {
    return position === "bottom-left" /* BL */ || position === "top-left" /* TL */ ? "left" : "right";
  }
  ...
  async walletEntryRander() {
    ...
    if (btnX && btnY) {
      ...
      const position = this._walletOptions.entryPosition || "bottom-left" /* BL */;
      let top, left;
      ...
      walletBtn.setAttribute("data-position", position == null ? void 0 : position.toLowerCase());
      this.updateIframeContentPosition();
    }
    let isDraggie = false;
    ...
    const controlIframe = (0, import_debounce.default)(() => {
      ...
      if (!isDraggie) {
        const iframeContent = document.querySelector(".particle-pwe-iframe-content");
        if ((_b = (_a = iframeContent == null ? void 0 : iframeContent.classList) == null ? void 0 : _a.contains) == null ? void 0 : _b.call(_a, "particle-pwe-iframe-content-show")) {
          this.closeWallet();
        } else {
          this.openWallet();
        }
    ...
    if (!isListen) {
      ...
      window.addEventListener(
        ...
        (events) => {
          ...
          if (((_b = (_a = window.walletEntryPlugin) == null ? void 0 : _a.walletOptions) == null ? void 0 : _b.widgetIntegration) === "embedded") {
            return;
          }
          if (((_c = events == null ? void 0 : events.data) == null ? void 0 : _c.type) === "PARTICLE_WALLET_RESIZE_IFRAME") {
            const walletEntryPlugin2 = window.walletEntryPlugin;
            const iframeContent = document.querySelector(".particle-pwe-iframe-content");
            const classList = iframeContent == null ? void 0 : iframeContent.classList;
            if ((_d = classList == null ? void 0 : classList.contains) == null ? void 0 : _d.call(classList, fullScreenClass)) {
              if (!((_e = this._walletOptions) == null ? void 0 : _e.visible) || window.screen.width < 600) {
                walletEntryPlugin2.closeWallet();
              } else {
                (_f = classList == null ? void 0 : classList.remove) == null ? void 0 : _f.call(classList, fullScreenClass);
                walletEntryPlugin2.resize();
                walletEntryPlugin2.updateIframeContentPosition();
              }
            } else {
              (_g = classList == null ? void 0 : classList.add) == null ? void 0 : _g.call(classList, fullScreenClass);
            }
          } else if (((_h = events == null ? void 0 : events.data) == null ? void 0 : _h.type) === "PARTICLE_WALLET_CLOSE_IFRAME") {
